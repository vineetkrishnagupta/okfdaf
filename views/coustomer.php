            ...
            <div class="card-body">
                ...
                <div>
                    <table>
                        <tr>
                            <th>
                                <h5><b>All Customer</b> </h5>
                            </th>
                            <th><a href="../torouter/add/customer" class="btn btn-success">ADD Customer</a></th>
                        </tr>
                    </table>
                </div>
                <div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            while ($row = $stmt->fetch()) {
                                ...
                                <td>" . $row['email'] . "</td>
                                <td>" . $row['password'] . "</td>
                                <td><a href='../torouter/action/deletecustomer.php?id=" . $row['id'] . "' class='btn btn-danger mx-2'>Delete</a><a href='/' class='btn btn-success'>Update</a></td>
                                </tr>";
                            }
